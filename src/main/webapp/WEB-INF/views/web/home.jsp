...
<body >
                    ...
                    <div>
                        ...
                        <div class="space-y-2 max-h-36 overflow-y-auto">
                            <div class="flex justify-between items-center bg-gray-100 p-2 rounded-lg shadow cursor-pointer transform transition duration-300 hover:bg-gray-200 hover:shadow-md">
                                <span>Table #1 (1350+)</span>
                                <button onclick="chuyenTrang('<c:url value="/PvP?room=1"></c:url>',1350,10000)" class="bg-gradient-to-r from-gray-400 to-gray-600 text-white px-4 py-1 rounded-lg hover:from-gray-500 hover:to-gray-700 transition duration-300 shadow transform hover:scale-105">Join</button>
                            </div>
                            <div class="flex justify-between items-center bg-gray-100 p-2 rounded-lg shadow cursor-pointer transform transition duration-300 hover:bg-gray-200 hover:shadow-md">
                                <span>Table #2 (1000-1700)</span>
                                <button onclick="chuyenTrang('<c:url value="/PvP?room=2"></c:url>',1000,1700)" class="bg-gradient-to-r from-gray-400 to-gray-600 text-white px-4 py-1 rounded-lg hover:from-gray-500 hover:to-gray-700 transition duration-300 shadow transform hover:scale-105">Join</button>
                            </div>
                            <div class="flex justify-between items-center bg-gray-100 p-2 rounded-lg shadow cursor-pointer transform transition duration-300 hover:bg-gray-200 hover:shadow-md">
                                <span>Table #3 (Open)</span>
                                <button onclick="chuyenTrang('<c:url value="/PvP?room=3"></c:url>',0,10000)" class="bg-gradient-to-r from-gray-400 to-gray-600 text-white px-4 py-1 rounded-lg hover:from-gray-500 hover:to-gray-700 transition duration-300 shadow transform hover:scale-105">Join</button>
                            </div>
                             <div class="flex justify-between items-center bg-gray-100 p-2 rounded-lg shadow cursor-pointer transform transition duration-300 hover:bg-gray-200 hover:shadow-md">
                                <span>Table #4 (Open)</span>
                                <button onclick="chuyenTrang('<c:url value="/PvP?room=4"></c:url>',0,10000)" class="bg-gradient-to-r from-gray-400 to-gray-600 text-white px-4 py-1 rounded-lg hover:from-gray-500 hover:to-gray-700 transition duration-300 shadow transform hover:scale-105">Join</button>
                            </div>
                             <div class="flex justify-between items-center bg-gray-100 p-2 rounded-lg shadow cursor-pointer transform transition duration-300 hover:bg-gray-200 hover:shadow-md">
                                <span>Table #5 (Open)</span>
                                <button onclick="chuyenTrang('<c:url value="/PvP?room=5"></c:url>',0,10000)" class="bg-gradient-to-r from-gray-400 to-gray-600 text-white px-4 py-1 rounded-lg hover:from-gray-500 hover:to-gray-700 transition duration-300 shadow transform hover:scale-105">Join</button>
                            </div>
                             <div class="flex justify-between items-center bg-gray-100 p-2 rounded-lg shadow cursor-pointer transform transition duration-300 hover:bg-gray-200 hover:shadow-md">
                                <span>Table #6 (Open)</span>
                                <button onclick="chuyenTrang('<c:url value="/PvP?room=6"></c:url>',0,10000)" class="bg-gradient-to-r from-gray-400 to-gray-600 text-white px-4 py-1 rounded-lg hover:from-gray-500 hover:to-gray-700 transition duration-300 shadow transform hover:scale-105">Join</button>
                            </div>
                        </div>
                    </div>
                    <div>
                        <h3 class="text-lg font-semibold mb-2 text-gray-700"></h3>
    ...
    <script type="text/javascript">
         function chuyenTrang(url,a,b) {
        	if (a<=${USERMODEL.getElo()}&&${USERMODEL.getElo()}<=b){
        		
	        	window.location.assign(url); 
        	} 
        	else{
        		alert("Hãy chọn phòng phù hợp với elo của bạn");
        	}
    }
    </script>
</body>
